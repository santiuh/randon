...
const data = [
  ...
  },
  {
    ...
    botones: [
      { nombre: "Catálogo Gral. Rodamientos", archivo: "fersa1.pdf" },
      { nombre: "Catálogo Rodamientos", archivo: "fersa2.pdf" },
    ],
  },
  {
    marca: "HCH",
  ...
  },
  {
    ...
    botones: [{ nombre: "Catálogo de Tensores", archivo: "kugell.pdf" }],
  },
  {
    marca: "LOCTITE",
    texto:
