<template>
  <div class="flex place-content-center">
    <div class="flex flex-row py-16 justify-center max-w-[1440px] gap-12">
      <div class="flex flex-col text-2xl font-medium text-center items-center">
          <NuxtImg class="mb-3" src="svg/Sec1_1.svg"></NuxtImg>
      ...
      <div class="flex flex-col text-2xl font-medium text-center items-center">
          ...
          <NuxtImg class="mb-3" src="svg/Sec1_2.svg"></NuxtImg>
      ...
      <div class="flex flex-col text-2xl font-medium text-center items-center">
          ...
          <NuxtImg class="mb-3" src="svg/Sec1_3.svg"></NuxtImg>
      ...
      <div class="flex flex-col text-2xl font-medium text-center items-center">
          ...
          <NuxtImg class="mb-3" src="svg/Sec1_4.svg"></NuxtImg>
        <p class="text-nowrap">Servicio de capacitaciones</p>
